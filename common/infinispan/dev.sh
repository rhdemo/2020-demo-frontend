...
docker run --net=host --name 2020-demo-infinispan -d --rm -v ${DIR}/config:/config:z -p 11222:11222 -e CONFIG_PATH="/config/server.yaml" infinispan/server:10.1.1.Final
